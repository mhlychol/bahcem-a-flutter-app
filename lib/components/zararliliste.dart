...
class Zararliliste extends StatelessWidget {
  final Zararli zararli;
  
  const Zararliliste({Key? key, required this.zararli});
 
  @override
  Widget build(BuildContext context) {
    int? imageIndex = LocalImageService.getImageIndex('${zararli.imagepathzararli}');
